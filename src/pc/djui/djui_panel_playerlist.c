...
#include "textures/segment2/custom_ping_full_one_off.rgba16.inc.c"
};

ALIGNED8 const u8 texture_ping_full_two_off[] = {
#include "textures/segment2/custom_ping_full_two_off.rgba16.inc.c"
};

ALIGNED8 const u8 texture_ping_full_three_off[] = {
#include "textures/segment2/custom_ping_full_three_off.rgba16.inc.c"
};
